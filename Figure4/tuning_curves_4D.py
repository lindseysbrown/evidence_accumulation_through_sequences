...
alldata = np.load('bumpModel.npy') #simulated neural activity data
...
nLs = [323, 325, 327, 329, 331] #indices of selected left neurons
...
nRs = [333, 335, 337, 339, 341] #indices of selected right neurons
