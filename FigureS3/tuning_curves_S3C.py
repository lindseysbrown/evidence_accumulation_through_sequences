...
trialdata = pd.read_pickle('ExampleData/trialdata.pkl') #read in trial data used for simulations
...
alldata = np.load('jointbumpsol.npy') #load results of running planar_bump_attractor
alldata = alldata.T
